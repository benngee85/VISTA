    ...
    try {
      ...
      await writeFile(
        ...
        [
          ...
          // Synthetic test input only. The production seeder remains
          // fail-closed when its host-side LLM authority is absent.
          'LLM_API_KEY=fixture-only-not-a-runtime-secret',
