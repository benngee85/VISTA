...
VISTA has a free public dashboard and paid tiers for analyst workflows, API access and organization deployments.
...
- **Pro — Personal license:** one named subscriber may use VISTA for their own research, learning, investing and decisions. It does not cover employer, business or client use.
...
- License: Commercial license included — use VISTA for client work, internal tools and reporting
...
- Best for: Developers and teams that want programmatic access to VISTA intelligence data
...
- License: Commercial license for your customers — embed VISTA data in what you sell; the 5 bundled Pro seats all require the same company email domain
