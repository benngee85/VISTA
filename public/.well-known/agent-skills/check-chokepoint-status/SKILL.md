...
Use this skill when the user asks about the current state of a maritime chokepoint — disruption, congestion, active warnings, or affected trade routes. VISTA tracks 13 chokepoints with live AIS vessel-transit intelligence and per-chokepoint disruption scoring.
